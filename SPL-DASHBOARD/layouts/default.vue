<template>
  <v-app>
    <v-app-bar height="80" dark color="primary" :clipped-right="clipped" fixed app class="px-md-6">
            ...
            <template>
              ...
              <v-col cols="auto" class="hidden-xs-only">
                <v-btn text nuxt to="/setting">
                  Setting <v-icon class="ml-3">mdi-cog</v-icon>
                </v-btn>
              </v-col>
              <v-col cols="auto" class="hidden-xs-only">
                <v-btn light color="white" nuxt to="/logout" replace>
                  Logout <v-icon class="ml-3">mdi-logout</v-icon>
                </v-btn>
              </v-col>
            </template>
    ...
    <v-navigation-drawer disable-resize-watcher dark color="primary" v-model.trim="rightDrawer" right fixed app>
      <v-list-item>
        <v-list-item>
          <v-list-item-content>
      ...
      <v-list>
        ...
        <v-list-item class="text-center justify-center">
          <v-btn light min-width="60" large nuxt to="/logout" replace>
